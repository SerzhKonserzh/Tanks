	...
	: font(font)
{
	...
	if (!this->containerTexture.loadFromFile("images/paused.jpg"))
	{
		throw "ERROR::PAUSE_MENU_STATE::FAILED_TO_LOAD_BACKGROUND_TEXTURE";
	}

	this->container.setTexture(&this->containerTexture);
